...
PAIRS = [
    ("route.py",            "kicad_routing_plugin/routing_dialog.py",   "batch_route"),
...
# (routing_dialog.get_routing_config, ~30 keys, in _create_differential_tab)
# while single-ended routing uses routing_dialog._build_routing_config (~83 keys). 53
