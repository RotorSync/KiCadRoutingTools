...
_PARAM_CONTROL_ALIASES = {
    ...
    # route_diff's explicit-pair escape hatch (--pair POS_NET:NEG_NET): a flat
    # list of net-name tokens -> the diff tab's text control, which parses them
    # back into pairs (accepts both 'POS:NEG' and 'POS NEG' forms).
